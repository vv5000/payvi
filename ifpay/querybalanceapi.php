...
<div class="container">
    ...
    <div class="row main">
        <div class="col-sm-8">
            <form class="m-t" method="POST" action="/ifpay/querybalance.php">
                <div class="form-group">
                    <label for="baseUri">余额查询服务器地址</label>
                    <div class="input-group">
                        <input type="text" class="form-control" id="baseUri"
                               name="baseUri" placeholder=""
                               value="" aria-describedby="basic-addon2">
                        <span class="input-group-addon" id="basic-addon2">/search/queryBalance</span>
                    </div>
                </div>
                <hr />
