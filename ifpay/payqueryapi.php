...
<div class="container">
    ...
    <div class="row main">
        <div class="col-sm-8">
            <form class="m-t" method="post" action="/ifpay/payquery.php">
                <div class="form-group">
                    <label for="baseUri">支付查询服务器地址</label>
                    <div class="input-group">
                        <input type="text" class="form-control" id="baseUri"
                               name="baseUri" placeholder=""
                               value="" aria-describedby="basic-addon2">
                        <span class="input-group-addon"
                              id="basic-addon2">/payment/v1/order/{merchantId}-{orderNo}</span>
                    </div>
                </div>
                <hr/>
                <div class="form-group">
                    <label for="orderNo">订单号</label> <input type="text"
