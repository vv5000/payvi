            ...
            <div class="ibox-content">
                ...
                <form class="layui-form" action="" autocomplete="off" id="profile">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="password" name="p[newpwd]" lay-verify="required" placeholder="" readonly onfocus="this.removeAttribute('readonly');" autocomplete="off" class="layui-input" value="">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="password" name="p[secondpwd]" lay-verify="title" readonly onfocus="this.removeAttribute('readonly');" autocomplete="off"
                                   placeholder="" class="layui-input" value="">
                        </div>
                    </div>
