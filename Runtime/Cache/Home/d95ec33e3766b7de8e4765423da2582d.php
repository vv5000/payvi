        ...
        <div class="page-wrapper m-0 pt-5">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-4">
                        <h2 class="font-25 font-medium" style="text-align: center;padding-bottom: 20px;padding-top: 100px;"><?php echo ($sitename); ?> - 商户登录</h2>
                        <div class="card border-0">
                            <div class="card-body p-0">
                                <form class="form bordered-input" id="formlogin" name="formlogin" method="post" role="form" action="<?php echo ($user_checklogin); ?>">
                                    <div class="p-30 pb-0">
            ...
            $.ajax({
                ...
                success:function(result){
                    if(result['status'] == 0){
                        ...
                        setTimeout(function() {
                            window.location.href = "<?php echo ($domain); ?>" + "user_Index_index.html";
                        },3000 );
