                            ...
                            <table class="table table-hover" lay-data="{width:'100%',limit:<?php echo ($rows); ?>}">
								...
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td>
                                           ...
                                           <td><span id="dfRate<?php echo ($p["id"]); ?>"><span style="color:green">D+0</span>：<?php echo ($p["t0defaultrate"]); ?>，<span style="color:red">T+1</span>：<?php echo ($p["defaultrate"]); ?></span></td>
                                        <td><span id="fdRate<?php echo ($p["id"]); ?>"><span style="color:green">D+0</span>：<?php echo ($p["t0rate"]); ?>，<span style="color:red">T+1</span>：<?php echo ($p["rate"]); ?></span></td>
