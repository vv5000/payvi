        ...
        <div class="page-wrapper m-0 pt-5">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-4">
                        <h2 class="font-25 font-medium" style="text-align: center;padding-bottom: 20px;padding-top: 100px;"><?php echo ($sitename); ?> - 后台管理</h2>
                        ...
                        <div class="text-center mt-5">
                            <ul class="social-network">
                                <li>Copyright © 2018 <?php echo ($sitename); ?> 版权所有</li>
