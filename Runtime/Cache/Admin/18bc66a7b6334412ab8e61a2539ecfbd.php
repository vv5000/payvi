            ...
            <div class="layui-inline">
              ...
              <div class="layui-input-inline">
                <select name="status">
                  ...
                  <option <?php if($status == 3): ?>selected<?php endif; ?> value="3">成功，未入账</option>
                </select>
              </div>
              <div class="layui-input-inline">
                <select name="ddlx">
          ...
          <table class="layui-table" lay-data="{width:'100%',limit:<?php echo ($rows); ?>,id:'userData'}">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
               ...
               <td>
                ...
                <td style="text-align:center;"><?php echo (date('m-d H:i:s',$vo["pays_applydate"])); ?></td>
                <td style="text-align:center;"><?php if($vo[pays_successdate]): echo (date('m-d H:i:s',$vo["pays_successdate"])); else: ?> ---<?php endif; ?></td>
                ...
                <td style="text-align:center; color:#369"><?php echo (status($vo['pays_status'])); ?>
                <?php if($vo[pays_status] == 3): ?>成功,未入账<?php endif; ?>
                </td>
                <td><button  class="layui-btn layui-btn-small" onclick="order_view('系统订单号:<?php echo ($vo["pays_orderid"]); ?>','<?php echo U('Admin/Order/show',['oid'=>$vo[id]]);?>',400)">订单详情</button>
                 
                  <?php if(($vo["pays_status"]) == "0"): ?><button  class="layui-btn layui-btn-small layui-btn-danger" onclick="setOrderPaid('设置订单为已支付','<?php echo U('Admin/Order/setOrderPaid',['orderid'=>$vo[id]]);?>',400)">设置为已支付</button><?php endif; ?>
                  
                <?php if(($vo["pays_status"]) != "0"): if($vo['lock_status']==1): ?><button class="layui-btn layui-btn-small layui-btn-normal">订单冻结中</button><?php endif; endif; ?>
                  
                    <?php if(($vo["pays_status"]) != "0"): if($vo['lock_status']==0): ?><button class="layui-btn layui-btn-small layui-btn-normal" onclick="forzenOrder(this,'<?php echo ($vo["id"]); ?>')">冻结订单</button><?php endif; ?>
                       <?php if($vo['lock_status']==2): ?><button class="layui-btn layui-btn-small layui-btn-normal">已解冻订单</button><?php endif; endif; ?>
                </td>
