...
<div class="row">
    <div class="col-md-12">
      ...
      <blockquote class="layui-elem-quote" style="font-size:14px;padding;8px;">今日结算总金额：<span class="label label-info"><?php echo ($stat["totay_total"]); ?>元</span> 今日待结算：<span class="label label-warning"><?php echo ($stat["totay_wait"]); ?>元</span> 今日平台手续费利润：<span class="label label-info"><?php echo ($stat["totay_profit"]); ?>元</span> 今日完成笔数：<span class="label label-info"><?php echo ($stat["totay_success_count"]); ?></span> 今日驳回笔数：<span class="label label-danger"><?php echo ($stat["totay_fail_count"]); ?></span></blockquote>
                <blockquote class="layui-elem-quote" style="font-size:14px;padding;8px;">本月结算总金额：<span class="label label-info"><?php echo ($stat["month_total"]); ?>元</span> 本月待结算：<span class="label label-warning"><?php echo ($stat["month_wait"]); ?>元</span> 本月平台手续费利润：<span class="label label-info"><?php echo ($stat["month_profit"]); ?>元</span> 本月完成笔数：<span class="label label-info"><?php echo ($stat["month_success_count"]); ?></span> 本月驳回笔数：<span class="label label-danger"><?php echo ($stat["month_fail_count"]); ?></span></blockquote>
                
                 <blockquote class="layui-elem-quote" style="font-size:14px;padding;8px;">
结算总金额：<span class="label label-info"><?php echo ($stat["total"]); ?>元</span> 
待结算：<span class="label label-warning"><?php echo ($stat["total_wait"]); ?>元</span> 
平台手续费利润：<span class="label label-info"><?php echo ($stat["total_profit"]); ?>元</span> 
完成笔数：<span class="label label-info"><?php echo ($stat["total_success_count"]); ?></span> 
驳回笔数：<span class="label label-danger"><?php echo ($stat["alltotal_fail_count"]); ?></span></blockquote>       
                ...
                <table class="layui-table" lay-data="{width:'100%',limit:<?php echo ($rows); ?>,id:'userData'}">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                          ...
                          <td>
                                <?php if($vo['status'] < 2): ?><button class="layui-btn layui-btn-warm layui-btn-mini" onclick="widthdrawal_op('结算商户编号:<?php echo ($vo["userid"]); ?>','<?php echo U('Admin/Withdrawal/editStatus',['id'=>$vo[id]]);?>',510,280)">结算设置</button><?php endif; ?>
                            </td>
