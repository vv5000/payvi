...
<!--                                 <div class="layui-input-inline">
                    ...
                    <table class="layui-table" lay-data="{width:'100%',limit:<?php echo ($rows); ?>,id:'userData'}">
                        <thead>
                        <tr>
                            <th lay-data="{field:'memberid', width:105}">商户ID</th>
                            <th lay-data="{field:'username', width:130}">商户名称</th>
                            <th lay-data="{field:'groupid', width:100}">商户类型</th>
                            <th lay-data="{field:'parentid', width:130}">上级代理</th>
                            <th lay-data="{field:'status', width:80}">状态</th>
                            <th lay-data="{field:'authorized', width:85}">认证</th>
                            <th lay-data="{field:'charge', width:80}">充值</th>
                            <th lay-data="{field:'money', width:240,style:'cursor: pointer;'}">账户总额</th>               
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                               ...
                               <td>
                                ...
                                <td><div title="商户资金管理"
                                 ...
                                 资金：<?php echo round($vo[balance],4);?>   元 冻结：<?php echo round($vo[blockedbalance],4);?> 元<!--投诉保证金：<?php echo round($vo[complaintsDeposit],4);?>--></div></td>
