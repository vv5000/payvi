        ...
        <form class="layui-form" action="" autocomplete="off" id="baseForm">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="config[websitename]" value="<?php echo ($vo["websitename"]); ?>" lay-verify="required" autocomplete="off" placeholder="久付支付系统" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="radio" name="config[hdhd]" value="1" title="开启" <?php if($vo['hdhd'] == 1): ?>checked<?php endif; ?>>
                    <input type="radio" name="config[hdhd]" value="0" title="关闭" <?php if($vo['hdhd'] == 0): ?>checked<?php endif; ?>>
                </div>
            </div>
              <div class="layui-form-item">
                <label class="layui-form-label">是否用我码：</label>
                <div class="layui-input-block">
                    <input type="radio" name="config[ewm]" value="1" title="开启" <?php if($vo['ewm'] == 1): ?>checked<?php endif; ?>>
                    <input type="radio" name="config[ewm]" value="0" title="关闭" <?php if($vo['ewm'] == 0): ?>checked<?php endif; ?>>
                </div>
            </div>
            <div class="layui-form-item">
