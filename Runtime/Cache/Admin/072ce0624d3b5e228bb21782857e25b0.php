    ...
    <div class="col-md-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                        ...
                        <div class="layui-inline">
                            <div class="layui-input-inline">
                                <select name="tongdao">
                                    ...
                                    <?php if(is_array($banklist)): $i = 0; $__LIST__ = $banklist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option <?php if($tongdao == $vo[id]): ?>selected<?php endif; ?>
                            ...
                            <div class="layui-input-inline">
                                <select name="bank">
                                    ...
                                    <option <?php if($bank == 16): ?>selected<?php endif; ?> value="17">手动结算驳回退回手续费</option>
                                </select>
                            </div>
                ...
                <?php if($_GET[bank] == 9): ?><blockquote class="layui-elem-quote" style="font-size:14px;padding;8px;">今日佣金：<span class="label label-info"><?php echo ($stat["todaysum"]); ?>元</span> 今日佣金笔数：<span class="label label-warning"><?php echo ($stat["todaycount"]); ?>笔</span></blockquote>
                <blockquote class="layui-elem-quote" style="font-size:14px;padding;8px;">总佣金：<span class="label label-info"><?php echo ($stat["totalsum"]); ?>元</span> 总佣金笔数：<span class="label label-warning"><?php echo ($stat["totalcount"]); ?>笔</span> </blockquote><?php endif; ?>
                <!--交易列表-->
...
<script>
    ...
    $('#export').on('click',function(){
        window.location.href
            ="<?php echo U('Admin/Order/exceldownload',array('memberid'=>$memberid,'orderid'=>$orderid,'createtime'=>$createtime,'tongdao'=>$tongdao,'bank'=>$bank));?>";
    });
